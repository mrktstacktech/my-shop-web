    ...
    return (
        <div className="component-container poster-grid">
            ...
            <div className="grid grid-cols-2 gap-4 poster-grid__posters">
                <Image src="/public/ps5.svg" alt="PS5" className="object-cover w-[300px]" classNameBackground="relative items-end  bg-black w-full h-full object-cover rounded-sm">
                ...
                <div className="grid grid-row-2 gap-4">
                    <Image src="/public/woman.svg" alt="iPhone 14 Pro" className="object-cover rounded-sm" classNameBackground="relative bg-black w-full h-full object-cover rounded-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Image src="/public/speaker.svg" alt="PS5" className=" object-cover" classNameBackground="relative bg-black w-full h-full object-cover p-10 rounded-sm">
                            <div className="absolute flex flex-col bottom-0 left-0 pl-5 transform -translate-y-1/3">
